                ...
                <div class="relative flex flex-col items-center justify-center p-6 border-2 border-dashed rounded-lg cursor-pointer hover:bg-gray-50 transition"
                    ...
                    <template v-if="previewUrl">
                        ...
                        <div class="flex gap-2 mt-3">
                            ...
                            <a :href="previewUrl" target="_blank" class="px-3 py-1 text-sm rounded bg-gray-100">Open</a>
                        </div>
                    </template>

                    <template v-else>
                        <svg class="w-10 h-10 text-gray-400 mb-2" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                d="M3 15a4 4 0 004 4h10a4 4 0 004-4V7a4 4 0 00-4-4H7a4 4 0 00-4 4v8z"></path>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 11l3 3 5-5">
                            </path>
                        </svg>
                        <div class="text-center">
                            <div class="text-sm font-medium text-gray-900">Click or drop an image here to upload</div>
